        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('special-programs.update', $specialProgram) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" 
                                           id="program_name" 
                                           name="program_name" 
                                           value="{{ old('program_name', $specialProgram->program_name) }}"
                                           required
                                ...
                                <div>
                                    ...
                                    <select id="program_type" 
                                        ...
                                        <option value="health" {{ old('program_type', $specialProgram->program_type) == 'health' ? 'selected' : '' }}>Health</option>
                                        <option value="education" {{ old('program_type', $specialProgram->program_type) == 'education' ? 'selected' : '' }}>Education</option>
                                        <option value="community" {{ old('program_type', $specialProgram->program_type) == 'community' ? 'selected' : '' }}>Community</option>
                                        <option value="youth" {{ old('program_type', $specialProgram->program_type) == 'youth' ? 'selected' : '' }}>Youth</option>
                                        <option value="women" {{ old('program_type', $specialProgram->program_type) == 'women' ? 'selected' : '' }}>Women</option>
                                        <option value="environment" {{ old('program_type', $specialProgram->program_type) == 'environment' ? 'selected' : '' }}>Environment</option>
                                        <option value="other" {{ old('program_type', $specialProgram->program_type) == 'other' ? 'selected' : '' }}>Other</option>
                                    </select>
                                    @error('program_type')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="description" 
                                              name="description" 
                                              rows="4"
                                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $specialProgram->description) }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="date" 
                                           id="start_date" 
                                           name="start_date" 
                                           value="{{ old('start_date', $specialProgram->start_date ? $specialProgram->start_date->format('Y-m-d') : '') }}"
                                ...
                                <div>
                                    ...
                                    <input type="date" 
                                           id="end_date" 
                                           name="end_date" 
                                           value="{{ old('end_date', $specialProgram->end_date ? $specialProgram->end_date->format('Y-m-d') : '') }}"
                                ...
                                <div>
                                    ...
                                    <input type="number" 
                                           id="duration_weeks" 
                                           name="duration_weeks" 
                                           value="{{ old('duration_weeks', $specialProgram->duration_weeks) }}"
                                           min="1"
                                ...
                                <div>
                                    ...
                                    <select id="meeting_frequency" 
                                        ...
                                        <option value="daily" {{ old('meeting_frequency', $specialProgram->meeting_frequency) == 'daily' ? 'selected' : '' }}>Daily</option>
                                        <option value="weekly" {{ old('meeting_frequency', $specialProgram->meeting_frequency) == 'weekly' ? 'selected' : '' }}>Weekly</option>
                                        <option value="bi-weekly" {{ old('meeting_frequency', $specialProgram->meeting_frequency) == 'bi-weekly' ? 'selected' : '' }}>Bi-weekly</option>
                                        <option value="monthly" {{ old('meeting_frequency', $specialProgram->meeting_frequency) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                        <option value="as-needed" {{ old('meeting_frequency', $specialProgram->meeting_frequency) == 'as-needed' ? 'selected' : '' }}>As Needed</option>
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('target_participants', $specialProgram->target_participants) }}"
                                           min="1"
                                ...
                                <div>
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('current_participants', $specialProgram->current_participants) }}"
                                           min="0"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="target_audience" 
                                              ...
                                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('target_audience') border-red-500 @enderror">{{ old('target_audience', $specialProgram->target_audience) }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" 
                                           id="location" 
                                           name="location" 
                                           value="{{ old('location', $specialProgram->location) }}"
                                           required
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           id="ward" 
                                           name="ward" 
                                           value="{{ old('ward', $specialProgram->ward) }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           id="district" 
                                           name="district" 
                                           value="{{ old('district', $specialProgram->district) }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           id="region" 
                                           name="region" 
                                           value="{{ old('region', $specialProgram->region) }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('coordinator_name', $specialProgram->coordinator_name) }}"
                                ...
                                <div>
                                    ...
                                    <input type="tel" 
                                           ...
                                           value="{{ old('coordinator_phone', $specialProgram->coordinator_phone) }}"
                                ...
                                <div>
                                    ...
                                    <input type="number" 
                                           id="budget" 
                                           name="budget" 
                                           value="{{ old('budget', $specialProgram->budget) }}"
                                           min="0"
                                           step="0.01"
                                ...
                                <div>
                                    ...
                                    <select id="status" 
                                        ...
                                        <option value="active" {{ old('status', $specialProgram->status) == 'active' ? 'selected' : '' }}>Active</option>
                                        <option value="planning" {{ old('status', $specialProgram->status) == 'planning' ? 'selected' : '' }}>Planning</option>
                                        <option value="suspended" {{ old('status', $specialProgram->status) == 'suspended' ? 'selected' : '' }}>Suspended</option>
                                        <option value="completed" {{ old('status', $specialProgram->status) == 'completed' ? 'selected' : '' }}>Completed</option>
                                        <option value="cancelled" {{ old('status', $specialProgram->status) == 'cancelled' ? 'selected' : '' }}>Cancelled</option>
                                    </select>
                                    @error('status')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div>
                                ...
                                <textarea id="notes" 
                                          ...
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('notes') border-red-500 @enderror">{{ old('notes', $specialProgram->notes) }}</textarea>
                                @error('notes')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="flex justify-between items-center pt-6 border-t">
                            <a href="{{ route('special-programs.show', $specialProgram) }}" 
