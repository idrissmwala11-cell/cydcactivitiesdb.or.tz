                                ...
                                <tbody>
                                    @foreach($skillsInformation as $skill)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-{{ $skill->gender === 'Male' ? 'primary' : 'pink' }}">
                                                    {{ $skill->gender }}
                                                </span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('skills-information.show', $skill) }}" class="btn btn-sm btn-info" title="View">
                                                        <i class="bi bi-eye"></i>
                                                    </a>
                                                    <a href="{{ route('skills-information.edit', $skill) }}" class="btn btn-sm btn-warning" title="Edit">
                                                        <i class="bi bi-pencil"></i>
                                                    </a>
                                                    <form action="{{ route('skills-information.destroy', $skill) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this record?')">
                                                        @csrf
                                                        @method('DELETE')
