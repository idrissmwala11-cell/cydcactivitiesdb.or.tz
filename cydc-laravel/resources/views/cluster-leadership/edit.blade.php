        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Edit Cluster Leadership Information</h5>
                    <a href="{{ route('cluster-leadership.index') }}" class="btn btn-secondary">
                        <i class="bi bi-arrow-left me-1"></i>Back to List
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('cluster-leadership.update', $clusterLeadership) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('cluster_name') is-invalid @enderror" 
                                           id="cluster_name" name="cluster_name" value="{{ old('cluster_name', $clusterLeadership->cluster_name) }}" required>
                                    @error('cluster_name')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('location') is-invalid @enderror" 
                                           id="location" name="location" value="{{ old('location', $clusterLeadership->yds_name) }}" required>
                                    @error('location')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('term_end') is-invalid @enderror" 
                                           id="term_end" name="term_end" value="{{ old('term_end', $clusterLeadership->leadership_term) }}" required>
                                    @error('term_end')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <hr>
                        <h6 class="mb-3">Cluster Leaders</h6>
                        
                        <div id="leaders-container">
                            @foreach($clusterLeadership->clusterLeaderDetails as $index => $detail)
                                <div class="leader-entry border rounded p-3 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label">Leader ID <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="leaders[{{ $index }}][leader_id]" 
                                                       value="{{ old('leaders.'.$index.'.leader_id', $detail->leader_id) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label">Position <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="leaders[{{ $index }}][leader_position]" 
                                                       value="{{ old('leaders.'.$index.'.leader_position', $detail->leader_position) }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    @if($index > 0)
...
<script>
let leaderIndex = {{ $clusterLeadership->clusterLeaderDetails->count() }};
