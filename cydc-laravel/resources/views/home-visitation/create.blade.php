                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('likes_program') is-invalid @enderror" id="likes_program" name="likes_program" required>
                                            ...
                                            <option value="Ndio" {{ old('likes_program') == 'Ndio' ? 'selected' : '' }}>Ndio</option>
                                            <option value="Hapana" {{ old('likes_program') == 'Hapana' ? 'selected' : '' }}>Hapana</option>
                                        </select>
                                        @error('likes_program')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('nyumba') is-invalid @enderror" id="nyumba" name="nyumba" required>
                                            <option value="">--Chagua--</option>
                                            <option value="Yao" {{ old('nyumba') == 'Yao' ? 'selected' : '' }}>Yao</option>
                                            <option value="Mkopo" {{ old('nyumba') == 'Mkopo' ? 'selected' : '' }}>Mkopo</option>
                                            <option value="Mpangaji" {{ old('nyumba') == 'Mpangaji' ? 'selected' : '' }}>Mpangaji</option>
                                        </select>
                                        @error('nyumba')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('paa') is-invalid @enderror" id="paa" name="paa" required>
                                            <option value="">--Chagua--</option>
                                            <option value="Bati" {{ old('paa') == 'Bati' ? 'selected' : '' }}>Bati</option>
                                            <option value="Nyasi" {{ old('paa') == 'Nyasi' ? 'selected' : '' }}>Nyasi</option>
                                            <option value="Nyingine" {{ old('paa') == 'Nyingine' ? 'selected' : '' }}>Nyingine</option>
                                        </select>
                                        @error('paa')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('choo') is-invalid @enderror" id="choo" name="choo" required>
                                            <option value="">--Chagua--</option>
                                            <option value="Wanachoo" {{ old('choo') == 'Wanachoo' ? 'selected' : '' }}>Wanachoo</option>
                                            <option value="Hawana choo" {{ old('choo') == 'Hawana choo' ? 'selected' : '' }}>Hawana choo</option>
                                        </select>
                                        @error('choo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('milo') is-invalid @enderror" id="milo" name="milo" required>
                                            ...
                                            <option value="Zaidi ya 3" {{ old('milo') == 'Zaidi ya 3' ? 'selected' : '' }}>Zaidi ya 3</option>
                                        </select>
                                        @error('milo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
