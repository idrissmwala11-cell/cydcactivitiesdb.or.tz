<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('skills-attendance.update', $skillsAttendance) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="date" name="date" type="date" class="mt-1 block w-full" :value="old('date', $skillsAttendance->date)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="present_count" name="present_count" type="number" class="mt-1 block w-full" :value="old('present_count', $skillsAttendance->present_count)" required min="0" />
                        ...
                        <div class="mt-8">
                            ...
                            <div id="participants-container">
                                @foreach($skillsAttendance->absentParticipants as $index => $participant)
    ...
    <script>
        let participantIndex = {{ count($skillsAttendance->absentParticipants) }};
