...
@section('title', 'FOMU YA TAARIFA ZA VIONGOZI WA NJE YA WIZARA')
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-2 border-blue-500">
            <div class="p-6">
                ...
                <form action="{{ route('out-of-ministry-leadership.store') }}" method="POST">
                    @csrf

                    <!-- Header -->
                    <div class="text-center mb-6">
                        <h2 class="text-xl font-bold text-gray-800">FOMU YA TAARIFA ZA VIONGOZI WA NJE YA WIZARA</h2>
                    </div>
