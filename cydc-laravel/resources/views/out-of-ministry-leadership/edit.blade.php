...
@section('title', 'HARIRI TAARIFA ZA VIONGOZI WA NJE YA WIZARA')
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-2 border-blue-500">
            <div class="p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-xl font-bold text-gray-800">HARIRI TAARIFA ZA VIONGOZI WA NJE YA WIZARA</h2>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="leaders_count" class="block text-sm font-medium text-gray-700 mb-2">
                                    1. Idadi ya Viongozi <span class="text-red-500">*</span>
                                </label>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border border-gray-300 px-4 py-2">
                                                    <select name="leaders[{{ $index }}][gender]" class="w-full px-2 py-1 border border-gray-300 rounded" required>
                                                        ...
                                                        <option value="male" {{ old('leaders.'.$index.'.gender', $detail->gender) == 'male' ? 'selected' : '' }}>Mwanaume</option>
                                                        <option value="female" {{ old('leaders.'.$index.'.gender', $detail->gender) == 'female' ? 'selected' : '' }}>Mwanamke</option>
                                                    </select>
                                                </td>
                                            </tr>
                                        @endforeach
