<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Taarifa za Viongozi wa Kituo - Maelezo') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow rounded-lg p-6 border-2 border-blue-300">
                <div class="text-center mb-6">
                    <h2 class="text-xl font-bold text-gray-800 uppercase">TAARIFA ZA VIONGOZI WA KITUO</h2>
                </div>
                ...
                <div class="border-b border-gray-200 pb-6 mb-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-md">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Jina la Kituo:</label>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900">{{ $centerLeadership->user->center_id ?? 'No Center ID' }}</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Idadi ya Viongozi:</label>
                                <p class="mt-1 text-sm text-gray-900">{{ count($centerLeadership->leadership_list) }} Viongozi</p>
                            </div>
                        </div>
                    </div>
                </div>
