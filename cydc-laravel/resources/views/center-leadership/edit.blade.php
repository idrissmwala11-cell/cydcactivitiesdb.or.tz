<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Hariri Taarifa za Viongozi wa Kituo') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow rounded-lg p-6 border-2 border-blue-300">
                <div class="text-center mb-6">
                    <h2 class="text-xl font-bold text-gray-800 uppercase">HARIRI FOMU YA TAARIFA ZA VIONGOZI WA KITUO</h2>
                </div>
                ...
                <form method="POST" action="{{ route('center-leadership.update', $centerLeadership) }}" class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="center_name" class="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" value="{{ old('center_name', $centerLeadership->center_name) }}" placeholder="Weka idadi ya viongozi" required>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @foreach(old('leadership_list', $centerLeadership->leadership_list) as $index => $leader)
                                        <tr class="leadership-row">
                                            ...
                                            <td class="px-4 py-2 border border-gray-300 text-center">
                                                <button type="button" class="remove-row bg-red-500 text-white px-2 py-1 rounded text-sm hover:bg-red-600" {{ count($centerLeadership->leadership_list) <= 1 ? 'style=display:none' : '' }}>Ondoa</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div>
                            ...
                            <textarea name="challenges" class="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" rows="4" placeholder="Eleza changamoto zozote ambazo wanazokumbana nazo viongozi">{{ old('challenges', $centerLeadership->challenges) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <textarea name="feedback" class="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" rows="4" placeholder="Weka maoni yoyote kuhusu uongozi wa kituo">{{ old('feedback', $centerLeadership->feedback) }}</textarea>
                        </div>
                    </div>
