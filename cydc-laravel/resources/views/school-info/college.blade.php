        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <div class="text-center mb-6">
                    <h2 class="text-xl font-bold text-gray-800 uppercase">FOMU YA TAARIFA ZA CHUO</h2>
                </div>
                
                <form method="POST" action="{{ route('submissions.store') }}" class="space-y-6">
                    @csrf
                    <input type="hidden" name="section_type" value="school_college">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">2. Jina la Chuo: <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">5. Tarehe ya Kukamaliza (inayotarajiwa): <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">6. Anwani ya Chuo: <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">7. Changamoto za Sasa:</label>
                                <textarea name="form_data[current_challenges]" class="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" rows="4" placeholder="Tafadhali eleza changamoto yoyote ambazo mwanafunzi anakumbana nayo">{{ old('form_data.current_challenges') }}</textarea>
                            </div>
                        </div>
                    </div>
