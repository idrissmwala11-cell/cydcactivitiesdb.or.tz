                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            @php
                                $sectionConfig = [
                                    'masomo_ya_mtaala' => ['icon' => 'book-open', 'color' => 'blue', 'title' => 'Masomo ya Mtaala'],
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <!-- Edit Button -->
                            <a href="{{ route('admin.submissions.edit', $submission) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:border-indigo-900 focus:ring ring-indigo-300 disabled:opacity-25 transition ease-in-out duration-150">
                            ...
                            <!-- Delete Button -->
                            <form method="POST" action="{{ route('admin.submissions.destroy', $submission) }}" class="inline" onsubmit="return confirm('Are you sure you want to delete this submission? This action cannot be undone.');">
                                @csrf
                                @method('DELETE')
