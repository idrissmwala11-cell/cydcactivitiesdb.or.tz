                        ...
                        @if($section === 'vikoba')
                            ...
                            <div class="rounded-lg border border-{{ $config['color'] }}-200 p-6 bg-{{ $config['color'] }}-50/30">
                                ...
                                <div class="space-y-5">
                                    <!-- 1. Jina la Kikundi -->
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">1. Jina la Kikundi <span class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        ...
                                        <div class="overflow-hidden border rounded-lg">
                                            <div class="bg-{{ $config['color'] }}-600 text-white px-4 py-2 font-semibold grid grid-cols-12 gap-2">
                                                ...
                                                <div class="col-span-4">Namba ya Simu</div>
                                                <div class="col-span-1"></div>
                                            </div>
                                                ...
                                                @foreach($members as $idx => $m)
                                                    <div class="grid grid-cols-12 gap-2 p-2 items-center">
                                                        ...
                                                        <div class="col-span-1 text-right">
                                                            <button type="button" class="remove-member text-red-600 hover:text-red-800" aria-label="Ondoa">&times;</button>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
