        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4>{{ __('Edit Attendance Record') }}</h4>
                ...
                <div class="card-body">
                    <form action="{{ route('talent-attendance.update', $attendance->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('instructor_name') is-invalid @enderror" 
                                       id="instructor_name" name="instructor_name" value="{{ old('instructor_name', $attendance->instructor_name) }}" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('attendance_count') is-invalid @enderror" 
                                       id="attendance_count" name="attendance_count" value="{{ old('attendance_count', $attendance->attendance_count) }}" min="0" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('talent_taught') is-invalid @enderror" 
                                       id="talent_taught" name="talent_taught" value="{{ old('talent_taught', $attendance->talent_taught) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('lesson_topic') is-invalid @enderror" 
                                       id="lesson_topic" name="lesson_topic" value="{{ old('lesson_topic', $attendance->lesson_topic) }}" required>
                                @error('lesson_topic')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('instructor_comments') is-invalid @enderror" 
                                          id="instructor_comments" name="instructor_comments" rows="3">{{ old('instructor_comments', $attendance->instructor_comments) }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('supervisor_comments') is-invalid @enderror" 
                                          id="supervisor_comments" name="supervisor_comments" rows="3">{{ old('supervisor_comments', $attendance->supervisor_comments) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <p class="text-muted small">{{ __('Manage participants who were absent from this session') }}</p>
                            
                            <div id="absent-participants-container">
                                @php
                                    $existingParticipants = old('absent_participants', $attendance->absentParticipants->toArray());
                                @endphp
