        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('talents.edit', $talent) }}" class="btn btn-warning me-2">
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                        <a href="{{ route('talents.edit', $talent) }}" class="btn btn-warning me-md-2">
                            <i class="fas fa-edit"></i> {{ __('Edit Talent') }}
                        </a>
                        <form action="{{ route('talents.destroy', $talent) }}" method="POST" class="d-inline" 
