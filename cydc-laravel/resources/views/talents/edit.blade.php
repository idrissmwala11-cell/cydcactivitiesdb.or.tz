        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('talents.show', $talent) }}" class="btn btn-info me-2">
                ...
                <div class="card-body">
                    <form action="{{ route('talents.update', $talent) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('talent_type') is-invalid @enderror" 
                                       id="talent_type" name="talent_type" value="{{ old('talent_type', $talent->talent_type) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('talent_duration') is-invalid @enderror" 
                                       id="talent_duration" name="talent_duration" value="{{ old('talent_duration', $talent->talent_duration) }}" 
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('talents.show', $talent) }}" class="btn btn-secondary me-md-2">
                                {{ __('Cancel') }}
                            </a>
