...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Add New Curriculum Attendance')); ?>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <form action="<?php echo e(route('curriculum-attendance.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Date</label>
                            <input type="date" name="tarehe" value="<?php echo e(old('tarehe')); ?>" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Teacher Name</label>
                            <input type="text" name="jina_la_mwalimu" value="<?php echo e(old('jina_la_mwalimu')); ?>" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700">Lesson Topic</label>
                            <input type="text" name="somo" value="<?php echo e(old('somo')); ?>" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                        </div>
                    </div>

                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-700">Lesson Topic Details</label>
                        <textarea name="mada" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required><?php echo e(old('mada')); ?></textarea>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Teacher Comments</label>
                            <textarea name="maoni_ya_mwalimu" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"><?php echo e(old('maoni_ya_mwalimu')); ?></textarea>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Supervisor Comments</label>
                            <textarea name="maoni_ya_msimamizi" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"><?php echo e(old('maoni_ya_msimamizi')); ?></textarea>
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH /home/cydcacti/cydcactivitiesdb.or.tz/resources/views/curriculum-attendance/create.blade.php ENDPATH**/ ?>