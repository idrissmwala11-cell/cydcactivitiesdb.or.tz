        ...
        <nav class="container">
            <div class="logo">
                <div class="logo-switcher" aria-hidden="true">
                    <img src="<?php echo e(asset('public/logos/church-logo-1.jpeg')); ?>" alt="" class="logo-frame-a">
                    <img src="<?php echo e(asset('public/logos/church-logo-2.jpeg')); ?>" alt="" class="logo-frame-b">
                </div>
                <div class="logo-text">
            ...
            <div class="nav-links">
                <a href="#home"><?php echo e(__('ui.home')); ?></a>
                <a href="#mission"><?php echo e(__('ui.mission')); ?></a>
                <a href="#about"><?php echo e(__('ui.about')); ?></a>
                <a href="#services"><?php echo e(__('ui.services')); ?></a>
                <a href="#contact"><?php echo e(__('ui.contact')); ?></a>
            </div>
            <div class="auth-buttons">
                <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-solid"><?php echo e(__('ui.dashboard')); ?></a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline"><?php echo e(__('ui.login')); ?></a>
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-solid"><?php echo e(__('ui.register')); ?></a>
                        <?php endif; ?>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        ...
        <div class="container">
            <div class="hero-brand">
                <div class="hero-heading">
                    <h1>CYDC</h1>
                    <div class="hero-subtitle"><?php echo e(__('ui.welcome_hero_subtitle')); ?></div>
                    <div class="hero-clusters"><?php echo e(__('ui.clusters')); ?></div>
                </div>
            </div>
            <p><?php echo e(__('ui.hero_tagline')); ?></p>
            <a href="#mission" class="cta-button"><?php echo e(__('ui.learn_more')); ?></a>
        </div>
    </section>
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h4><?php echo e(__('ui.quick_links')); ?></h4>
                    <ul class="footer-links">
                        <li><a href="#home"><?php echo e(__('ui.home')); ?></a></li>
                        <li><a href="<?php echo e(route('register')); ?>"><?php echo e(__('ui.register')); ?></a></li>
                        <li><a href="<?php echo e(route('login')); ?>"><?php echo e(__('ui.login')); ?></a></li>
                    </ul>
                </div>
                
                <div class="footer-section footer-section--contact">
                    <h4><?php echo e(__('ui.contact_info')); ?></h4>
...
<?php /**PATH /home/cydcacti/cydcactivitiesdb.or.tz/resources/views/welcome.blade.php ENDPATH**/ ?>