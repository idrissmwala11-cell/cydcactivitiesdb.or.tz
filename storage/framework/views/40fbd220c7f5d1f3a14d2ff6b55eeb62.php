...
<div class="mb-4">
    ...
    <p class="text-xs text-gray-500 mb-2">
        Logged in as: <?php echo e(auth()->id()); ?> - <?php echo e(auth()->user()->email); ?>
    ...
    <div class="mt-2">
        <img
            ...
            alt="Profile Photo"
            onerror="this.onerror=null;this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($user->name ?? 'User')); ?>&background=e5e7eb&color=111827&size=160';"
        >
    </div>
...
</script><?php /**PATH /home/cydcacti/cydcactivitiesdb.or.tz/resources/views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>