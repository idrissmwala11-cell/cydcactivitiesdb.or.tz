...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <i class="bi bi-book me-2"></i><?php echo e(__('School Information: Primary')); ?>
                ...
                <form method="POST" action="<?php echo e(route($sectionRoute . '.store')); ?>" class="p-4 p-md-5">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="form_data[class_level]" class="form-control form-control-lg" value="<?php echo e(old('form_data.class_level')); ?>" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="form_data[best_subjects]" class="form-control form-control-lg" value="<?php echo e(old('form_data.best_subjects')); ?>" placeholder="Example: English, Science">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-semibold"><i class="bi bi-exclamation-circle me-2 text-primary"></i>Subjects with Challenges</label>
                            <input type="text" name="form_data[failed_subjects]" class="form-control form-control-lg" value="<?php echo e(old('form_data.failed_subjects')); ?>" placeholder="Example: Mathematics, English">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-semibold"><i class="bi bi-lightbulb me-2 text-primary"></i>Child's Dream</label>
                            <input type="text" name="form_data[child_dream]" class="form-control form-control-lg" value="<?php echo e(old('form_data.child_dream')); ?>" placeholder="Example: Doctor">
                        </div>
...
<?php endif; ?>
<?php /**PATH /home/cydcacti/cydcactivitiesdb.or.tz/resources/views/school-info/primary.blade.php ENDPATH**/ ?>