...
<head>
    ...
    <title><?php echo e(config('app.name', 'CYDC')); ?> - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
    ...
    <script src="<?php echo e(asset('js/search-test.js')); ?>"></script>
</head>
<body>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'sidebar-brand-logo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'sidebar-brand-logo']); ?>
...
<?php endif; ?>
                    ...
                    <span class="sidebar-brand-subtitle"><?php echo e(__('ui.brand_subtitle')); ?></span>
                </span>
            </a>
        </div>
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
                        ...
                        <span><?php echo e(__('ui.dashboard')); ?></span>
                    </a>
                </li>
                ...
                <?php if(auth()->user()->role === 'admin'): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('admin.dashboard')); ?>">
                            ...
                            <span><?php echo e(__('ui.admin_panel')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <li class="nav-item">
                    <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
                        <span><?php echo e(__('ui.programs')); ?></span>
                    </h6>
                </li>

                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('home-visitation.*') ? 'active' : ''); ?>" href="<?php echo e(route('home-visitation.index')); ?>">
                        <i class="bi bi-house-door"></i>
                        <span><?php echo e(__('ui.home_visitation')); ?></span>
                    </a>
                </li>

                
                <li class="nav-item dropdown-nav">
                    <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('submissions.*') || request()->routeIs('admin.masomo-ya-mtaala.*') || request()->routeIs('admin.masomo-ya-fani.*') || request()->routeIs('parents-information.*') || request()->routeIs('saving-groups.*') ? 'active' : ''); ?>"
                       href="#"
                       onclick="toggleDropdown(event, this)">
                        <i class="bi bi-calendar-event"></i>
                        <span><?php echo e(__('ui.program_day')); ?></span>
                    ...
                    <ul class="dropdown-menu">
                        <li class="nav-item">
                            <?php if(auth()->user()->role === 'admin'): ?>
                                <a class="nav-link <?php echo e(request()->routeIs('admin.masomo-ya-mtaala.*') ? 'active' : ''); ?>"
                                   href="<?php echo e(route('admin.masomo-ya-mtaala.index')); ?>">
                                    <i class="bi bi-book me-2"></i><?php echo e(__('ui.curriculum_studies')); ?>

                                </a>
                            <?php else: ?>
                                <a class="nav-link <?php echo e(request()->routeIs('submissions.masomo-ya-mtaala.*') ? 'active' : ''); ?>"
                                   href="<?php echo e(route('submissions.masomo-ya-mtaala.index')); ?>">
                                    <i class="bi bi-book me-2"></i><?php echo e(__('ui.curriculum_studies')); ?>
                        ...
                        <li class="nav-item">
                            <?php if(auth()->user()->role === 'admin'): ?>
                                <a class="nav-link <?php echo e(request()->routeIs('admin.masomo-ya-fani.*') ? 'active' : ''); ?>"
                                   href="<?php echo e(route('admin.masomo-ya-fani.index')); ?>">
                                    <i class="bi bi-pencil me-2"></i><?php echo e(__('ui.vocational_skills')); ?>

                                </a>
                            <?php else: ?>
                                <a class="nav-link <?php echo e(request()->routeIs('submissions.masomo-ya-fani.*') ? 'active' : ''); ?>"
                                   href="<?php echo e(route('submissions.masomo-ya-fani.index')); ?>">
                                    <i class="bi bi-pencil me-2"></i><?php echo e(__('ui.vocational_skills')); ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center <?php echo e(request()->routeIs('submissions.special-program.*') ? 'active fw-bold text-primary' : 'text-dark'); ?>"
                               href="<?php echo e(route('submissions.special-program.index')); ?>"
                               style="transition: all 0.3s ease;">
                                <i class="bi bi-star me-2 <?php echo e(request()->routeIs('submissions.special-program.*') ? 'text-warning' : ''); ?>"></i>
                                <span><?php echo e(__('ui.special_program')); ?></span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('parents-information.*') ? 'active' : ''); ?>"
                               href="<?php echo e(route('parents-information.index')); ?>">
                                <i class="bi bi-people me-2"></i><?php echo e(__('ui.parents')); ?>

                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('saving-groups.*') ? 'active' : ''); ?>"
                               href="<?php echo e(route('saving-groups.index')); ?>">
                                <i class="bi bi-piggy-bank me-2"></i><?php echo e(__('ui.savings_groups')); ?>
                ...
                <li class="nav-item dropdown-nav">
                    <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('*-attendance.*') ? 'active' : ''); ?>"
                       href="#"
                       onclick="toggleDropdown(event, this)">
                        <i class="bi bi-calendar-check"></i>
                        <span><?php echo e(__('ui.attendance')); ?></span>
                        <i class="bi bi-chevron-down ms-auto dropdown-arrow"></i>
                    </a>

                    <ul class="dropdown-menu">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('skills-attendance.*') ? 'active' : ''); ?>" href="<?php echo e(route('skills-attendance.index')); ?>">
                                <i class="bi bi-tools me-2"></i><?php echo e(__('ui.skills_attendance')); ?>

                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('curriculum-attendance.*') ? 'active' : ''); ?>" href="<?php echo e(route('curriculum-attendance.index')); ?>">
                                <i class="bi bi-journal-check me-2"></i><?php echo e(__('ui.curriculum_attendance')); ?>

                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('talent-attendance.*') ? 'active' : ''); ?>" href="<?php echo e(route('talent-attendance.index')); ?>">
                                <i class="bi bi-star me-2"></i><?php echo e(__('ui.talent_attendance')); ?>
...
<li class="nav-item dropdown-nav">
    <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('school-info.*') ? 'active' : ''); ?>"
       href="#"
       onclick="toggleDropdown(event, this)">
        <i class="bi bi-building"></i>
        <span><?php echo e(__('ui.school_information')); ?></span>
        <i class="bi bi-chevron-down ms-auto dropdown-arrow"></i>
    </a>
    ...
    <ul class="dropdown-menu">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo e(request()->routeIs('school-info.primary.*') ? 'active' : ''); ?>"
               href="<?php echo e(route('school-info.primary.index')); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo e(request()->routeIs('school-info.secondary.*') ? 'active' : ''); ?>"
               href="<?php echo e(route('school-info.secondary.index')); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo e(request()->routeIs('school-info.a-level.*') ? 'active' : ''); ?>"
               href="<?php echo e(route('school-info.a-level.index')); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo e(request()->routeIs('school-info.university.*') ? 'active' : ''); ?>"
               href="<?php echo e(route('school-info.university.index')); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo e(request()->routeIs('school-info.college.*') ? 'active' : ''); ?>"
               href="<?php echo e(route('school-info.college.index')); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo e(request()->routeIs('school-info.vocational-training.*') ? 'active' : ''); ?>"
               href="<?php echo e(route('school-info.vocational-training.index')); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo e(request()->routeIs('school-info.others.*') ? 'active' : ''); ?>"
               href="<?php echo e(route('school-info.others.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('school-visitation.*') ? 'active' : ''); ?>"
                       href="<?php echo e(route('school-visitation.index')); ?>">
                        <i class="bi bi-building-check"></i>
                        <span><?php echo e(__('ui.school_visitation')); ?></span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('local-sponsorship.*') ? 'active' : ''); ?>"
                       href="<?php echo e(route('local-sponsorship.index')); ?>">
                        <i class="bi bi-heart"></i>
                        <span><?php echo e(__('ui.local_sponsorship')); ?></span>
                    </a>
                </li>

                <li class="nav-item dropdown-nav">
                    <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('exam-results.*') ? 'active' : ''); ?>"
                       href="#"
                       onclick="toggleDropdown(event, this)">
                        <i class="bi bi-clipboard-data"></i>
                        <span><?php echo e(__('ui.exam_results')); ?></span>
                        <i class="bi bi-chevron-down ms-auto dropdown-arrow"></i>
                    </a>

                    <ul class="dropdown-menu">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('exam-results.primary.*') ? 'active' : ''); ?>"
                               href="<?php echo e(route('exam-results.primary.index')); ?>">
                                <i class="bi bi-1-circle me-2"></i>Primary
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('exam-results.secondary.*') ? 'active' : ''); ?>"
                               href="<?php echo e(route('exam-results.secondary.index')); ?>">
                                <i class="bi bi-2-circle me-2"></i>Secondary
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('exam-results.a-level.*') ? 'active' : ''); ?>"
                               href="<?php echo e(route('exam-results.a-level.index')); ?>">
                                <i class="bi bi-3-circle me-2"></i>A Level
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('exam-results.college.*') ? 'active' : ''); ?>"
                               href="<?php echo e(route('exam-results.college.index')); ?>">
                                <i class="bi bi-mortarboard me-2"></i>College
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('exam-results.university.*') ? 'active' : ''); ?>"
                               href="<?php echo e(route('exam-results.university.index')); ?>">
                ...
                <li class="nav-item dropdown-nav">
                    <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('center-leadership.*') || request()->routeIs('cluster-leadership.*') || request()->routeIs('base-leaders.*') || request()->routeIs('national-leadership.*') || request()->routeIs('out-of-ministry-leadership.*') ? 'active' : ''); ?>"
                       href="#"
                       onclick="toggleDropdown(event, this)">
                        <i class="bi bi-people-fill"></i>
                        <span><?php echo e(__('ui.leadership_information')); ?></span>
                        <i class="bi bi-chevron-down ms-auto dropdown-arrow"></i>
                    </a>

                    <ul class="dropdown-menu">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('center-leadership.*') ? 'active' : ''); ?>" href="<?php echo e(route('center-leadership.index')); ?>">
                                <i class="bi bi-geo-alt me-2"></i>Center
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('cluster-leadership.*') ? 'active' : ''); ?>" href="<?php echo e(route('cluster-leadership.index')); ?>">
                                <i class="bi bi-diagram-3 me-2"></i>Cluster
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('base-leaders.*') ? 'active' : ''); ?>" href="<?php echo e(route('base-leaders.index')); ?>">
                                <i class="bi bi-house me-2"></i>Base
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('national-leadership.*') ? 'active' : ''); ?>" href="<?php echo e(route('national-leadership.index')); ?>">
                                <i class="bi bi-flag me-2"></i>National
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('out-of-ministry-leadership.*') ? 'active' : ''); ?>" href="<?php echo e(route('out-of-ministry-leadership.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>" href="<?php echo e(route('reports.index')); ?>">
                        ...
                        <span><?php echo e(__('ui.reports')); ?></span>
                    </a>
                </li>
                
                <?php if(Auth::check() && Auth::user()->role === 'admin'): ?>
    <li class="nav-item">
        <a class="nav-link <?php echo e(request()->routeIs('admin.performance-report.*') ? 'active' : ''); ?>"
           href="<?php echo e(route('admin.performance-report.index')); ?>">
...
<?php endif; ?>
                ...
                <?php if(auth()->user()->role !== 'admin'): ?>
                    <li class="nav-item">
                        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
                            <span><?php echo e(__('ui.data_entry')); ?></span>
                        </h6>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('talent-attendance.*') ? 'active' : ''); ?>" href="<?php echo e(route('talent-attendance.index')); ?>">
                            <i class="bi bi-calendar-check"></i>
                            <span><?php echo e(__('ui.talent_attendance')); ?></span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('skills-attendance.*') ? 'active' : ''); ?>" href="<?php echo e(route('skills-attendance.index')); ?>">
                            ...
                            <span><?php echo e(__('ui.skills_attendance')); ?></span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('curriculum-attendance.*') ? 'active' : ''); ?>" href="<?php echo e(route('curriculum-attendance.index')); ?>">
                            ...
                            <span><?php echo e(__('ui.curriculum_attendance')); ?></span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('talents.*') ? 'active' : ''); ?>" href="<?php echo e(route('talents.index')); ?>">
                            <i class="bi bi-star"></i>
                            <span><?php echo e(__('ui.talents_information')); ?></span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('skills-information.*') ? 'active' : ''); ?>" href="<?php echo e(route('skills-information.index')); ?>">
                            <i class="bi bi-tools"></i>
                            <span><?php echo e(__('ui.skills_information')); ?></span>
                        </a>
                    </li>

                    
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('skills-to-learn.videos') ? 'active' : ''); ?>"
                           href="<?php echo e(route('skills-to-learn.videos')); ?>">
                            <i class="bi bi-play-circle"></i>
                            <span><?php echo e(__('ui.skills_to_learn')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(auth()->user()->role === 'admin'): ?>
                    <li class="nav-item">
                        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
                            <span><?php echo e(__('ui.data_management')); ?></span>
                        </h6>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('admin.submissions.*') ? 'active' : ''); ?>"
                           href="<?php echo e(route('admin.submissions.index')); ?>">
                            <i class="bi bi-calendar-event"></i>
                            <span><?php echo e(__('ui.manage_submissions')); ?></span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('admin.announcements.*') ? 'active' : ''); ?>"
                           href="<?php echo e(route('admin.announcements.index')); ?>">
                            <i class="bi bi-megaphone"></i>
                            <span><?php echo e(__('ui.announcements')); ?></span>
                        </a>
                    </li>

                    
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('admin.skill-videos.*') ? 'active' : ''); ?>"
                           href="<?php echo e(route('admin.skill-videos.index')); ?>">
                            <i class="bi bi-camera-video"></i>
                            <span><?php echo e(__('ui.skills_to_learn_videos')); ?></span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('talent-attendance.*') ? 'active' : ''); ?>" href="<?php echo e(route('talent-attendance.index')); ?>">
                            <i class="bi bi-calendar-check"></i>
                            <span><?php echo e(__('ui.all_talent_attendance')); ?></span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('skills-attendance.*') ? 'active' : ''); ?>" href="<?php echo e(route('skills-attendance.index')); ?>">
                            <i class="bi bi-calendar2-check"></i>
                            <span><?php echo e(__('ui.all_skills_attendance')); ?></span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('curriculum-attendance.*') ? 'active' : ''); ?>" href="<?php echo e(route('curriculum-attendance.index')); ?>">
                            <i class="bi bi-journal-check"></i>
                            <span><?php echo e(__('ui.all_curriculum_data')); ?></span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('talents.*') ? 'active' : ''); ?>" href="<?php echo e(route('talents.index')); ?>">
                            <i class="bi bi-star"></i>
                            <span><?php echo e(__('ui.all_talents_data')); ?></span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('skills-information.*') ? 'active' : ''); ?>" href="<?php echo e(route('skills-information.index')); ?>">
                            <i class="bi bi-tools"></i>
                            <span><?php echo e(__('ui.all_skills_data')); ?></span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('parents-information.*') ? 'active' : ''); ?>" href="<?php echo e(route('parents-information.index')); ?>">
                            <i class="bi bi-people"></i>
                            <span><?php echo e(__('ui.all_parents_data')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <li class="nav-item mt-4">
                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                        ...
                        <button type="submit" class="nav-link border-0 bg-transparent w-100 text-start">
                            ...
                            <span><?php echo e(__('ui.logout')); ?></span>
                        </button>
                    </form>
                </li>
            </ul>
    ...
    <div class="main-content" id="main-content">
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm mb-4">
            <div class="container-fluid">
                ...
                <?php if(auth()->user()->role !== 'admin' && request()->routeIs('dashboard')): ?>
                    <div class="topbar-dashboard-message ms-2 ms-md-0">
                        <div class="topbar-dashboard-message__content">
                            <p class="topbar-dashboard-message__title mb-0">
                                <?php echo e(__('ui.welcome_back')); ?>, <span><?php echo e(auth()->user()->center_id ?? __('ui.no_center_id')); ?></span>
                            </p>
                            <div class="topbar-dashboard-message__subtitle">
                                <?php echo e(__('ui.personal_dashboard')); ?>
                    ...
                    <div class="nav-item me-3">
                        <a class="nav-link position-relative px-0 topbar-icon-link topbar-chat-link"
                           ...
                           title="Chat">
                            ...
                            <span class="topbar-chat-label"><?php echo e(auth()->user()->role === 'admin' ? __('ui.chat_with_user') : __('ui.chat_with_admin')); ?></span>

                            <?php if(($chatUnreadCount ?? 0) > 0): ?>
                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                                    <?php echo e($chatUnreadCount > 99 ? '99+' : $chatUnreadCount); ?>
        ...
        <?php endif; ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0"
                            ...
                            style="width: 320px;">
                            <li class="dropdown-header fw-bold"><?php echo e(__('ui.notifications')); ?></li>
                                    ...
                                    <a href="<?php echo e(route('announcements.show', $announcement->id)); ?>"
                                       ...
                                       style="white-space: normal; text-decoration: none;">
                                        ...
                                        <div class="small text-muted" style="word-break: break-word;">
                                            <?php echo e(\Illuminate\Support\Str::limit($announcement->message, 80)); ?>
                            ...
                            <li>
                                <?php if(auth()->user()->role === 'admin'): ?>
                                    <a class="dropdown-item text-center fw-semibold"
                                       href="<?php echo e(route('admin.announcements.index')); ?>">
                                        <?php echo e(__('ui.view_all_announcements')); ?>

                                    </a>
                                <?php else: ?>
                                    <span class="dropdown-item-text text-center text-muted d-block">
                                        <?php echo e(__('ui.latest_announcements')); ?>
                        ...
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="me-2">
                                <?php if(auth()->user()->profile_photo): ?>
                                    <img
                                        src="/profile_photos/<?php echo e(rawurlencode(auth()->user()->profile_photo)); ?>?t=<?php echo e(time()); ?>"
                                        alt="Profile Photo"
                                        class="rounded-circle object-cover border border-white shadow"
                                        style="width: 32px; height: 32px;"
                                        onerror="this.onerror=null;this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->center_id ?? auth()->user()->name ?? 'User')); ?>&background=2563eb&color=ffffff&size=160';"
                                    >
                                <?php else: ?>
                                    <img
                                        src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->center_id ?? auth()->user()->name ?? 'User')); ?>&background=2563eb&color=ffffff&size=160"
                                        alt="Profile Photo"
                                        class="rounded-circle object-cover border border-white shadow"
                                        style="width: 32px; height: 32px;"
                                    >
                            ...
                            <span class="text-dark fw-semibold ms-2">
                                <?php echo e(auth()->user()->center_id ?? 'No Center ID'); ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>">
                                    <i class="bi bi-person me-2"></i><?php echo e(__('ui.profile')); ?>

                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="#" onclick="alert('Settings feature is coming soon!')">
                                    <i class="bi bi-gear me-2"></i><?php echo e(__('ui.settings')); ?>
                            ...
                            <li>
                                <form method="POST" action="<?php echo e(route('logout')); ?>">
                                    ...
                                    <button type="submit" class="dropdown-item">
                                        <i class="bi bi-box-arrow-right me-2"></i><?php echo e(__('ui.logout')); ?>
        ...
        <div class="offcanvas-header">
            <div>
                <h5 class="offcanvas-title mb-0" id="chatDrawerLabel">
                    <i class="bi bi-chat-dots me-2"></i><?php echo e(__('ui.chat')); ?>

                </h5>
                <small class="opacity-75"><?php echo e(auth()->user()->role === 'admin' ? __('ui.chat_with_users') : __('ui.chat_with_admin_small')); ?></small>
            </div>
        ...
        <div class="offcanvas-body p-0">
            <div class="d-flex flex-column h-100">
                <div class="border-bottom p-3 bg-light">
                    <div class="small text-muted mb-2"><?php echo e(auth()->user()->role === 'admin' ? 'Choose a user' : 'Admin contact'); ?></div>
                ...
                <div class="border-top p-3 bg-white">
                    <form id="chatMessageForm">
                        ...
                        <div class="d-flex justify-content-between align-items-center gap-2">
                            <a href="<?php echo e(route('chat.index')); ?>" class="btn btn-light border">Open Full Chat</a>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const announcementMarkReadUrl = <?php echo json_encode(route('announcements.mark-all-read'), 15, 512) ?>;
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const dataUrl = <?php echo json_encode(route('chat.data'), 15, 512) ?>;
        const sendUrl = <?php echo json_encode(route('chat.store'), 15, 512) ?>;
...
<?php /**PATH /home/cydcacti/cydcactivitiesdb.or.tz/resources/views/layouts/app.blade.php ENDPATH**/ ?>