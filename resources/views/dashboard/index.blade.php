...
<div class="fade-in">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-end">
                            <small class="text-muted">Developer (idriss mwala)</small>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="card dashboard-card h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="h4 mb-1">{{ number_format($stats['instructors']) }}</h3>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="card dashboard-card h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="h4 mb-1">{{ number_format($stats['programs']) }}</h3>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="card dashboard-card h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="h4 mb-1">{{ number_format($stats['sessions']) }}</h3>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="card dashboard-card h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="h4 mb-1">{{ number_format($stats['venues']) }}</h3>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="card dashboard-card h-100">
                <div class="card-body text-center">
                    <div class="card-icon bg-secondary mx-auto mb-3">
                        <i class="bi bi-star"></i>
                    </div>
                    <h3 class="h4 mb-1">{{ number_format($stats['skills']) }}</h3>
