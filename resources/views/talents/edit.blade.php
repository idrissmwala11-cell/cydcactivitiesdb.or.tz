        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4>{{ __('Edit Talent') }}</h4>
                    <div>
                        <a href="{{ route('talents.show', $talent->id) }}" class="btn btn-info me-2">
                    ...
                    <form action="{{ route('talents.update', $talent->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('student_name') is-invalid @enderror" 
                                       id="student_name" name="student_name" value="{{ old('student_name', $talent->student_name) }}" required>
                                @error('student_name')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('participant_number') is-invalid @enderror" 
                                       id="participant_number" name="participant_number" value="{{ old('participant_number', $talent->participant_number) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('age') is-invalid @enderror" 
                                       id="age" name="age" value="{{ old('age', $talent->age) }}" min="1" max="100" required>
                                @error('age')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('gender') is-invalid @enderror" id="gender" name="gender" required>
                                    ...
                                    <option value="Male" {{ old('gender', $talent->gender) === 'Male' ? 'selected' : '' }}>{{ __('Male') }}</option>
                                    <option value="Female" {{ old('gender', $talent->gender) === 'Female' ? 'selected' : '' }}>{{ __('Female') }}</option>
                                </select>
                                @error('gender')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('mentor') is-invalid @enderror" 
                                       id="mentor" name="mentor" value="{{ old('mentor', $talent->mentor) }}">
                                @error('mentor')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('talent_type') is-invalid @enderror" 
                                       id="talent_type" name="talent_type" value="{{ old('talent_type', $talent->talent_type) }}" required>
                                @error('talent_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('talent_duration') is-invalid @enderror" 
                                       id="talent_duration" name="talent_duration" value="{{ old('talent_duration', $talent->talent_duration) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('talent_description') is-invalid @enderror" 
                                      id="talent_description" name="talent_description" rows="3" required>{{ old('talent_description', $talent->talent_description) }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="has_competed" name="has_competed" 
                                           {{ old('has_competed', $talent->has_competed) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="needs_training" name="needs_training" 
                                           {{ old('needs_training', $talent->needs_training) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3" id="competition_details_section" style="display: {{ old('has_competed', $talent->has_competed) ? 'block' : 'none' }};">
                            ...
                            <textarea class="form-control @error('competition_details') is-invalid @enderror" 
                                      id="competition_details" name="competition_details" rows="2">{{ old('competition_details', $talent->competition_details) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('achievements') is-invalid @enderror" 
                                      id="achievements" name="achievements" rows="2">{{ old('achievements', $talent->achievements) }}</textarea>
                            @error('achievements')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>

                        <div class="mb-3" id="training_details_section" style="display: {{ old('needs_training', $talent->needs_training) ? 'block' : 'none' }};">
                            ...
                            <textarea class="form-control @error('training_details') is-invalid @enderror" 
                                      id="training_details" name="training_details" rows="2">{{ old('training_details', $talent->training_details) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('comments') is-invalid @enderror" 
                                      id="comments" name="comments" rows="2">{{ old('comments', $talent->comments) }}</textarea>
                            @error('comments')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('talents.show', $talent->id) }}" class="btn btn-secondary me-md-2">
                                {{ __('Cancel') }}
                            </a>
