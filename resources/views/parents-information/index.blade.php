...
<div class="container">
    ...
    <span class="badge bg-success">Approved</span>
                                        ...
                                        <td>
                                         ...
                                         <a href="{{ route('parents-information.show', $parent) }}" class="btn btn-sm btn-outline-info">
    <i class="bi bi-eye"></i>
</a>
<a href="{{ route('parents-information.edit', $parent) }}" class="btn btn-sm btn-outline-warning">
