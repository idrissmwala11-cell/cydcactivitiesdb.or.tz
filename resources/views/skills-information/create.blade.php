            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('skills-information.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="skill_category" class="form-label">Skill Category <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('skill_category') is-invalid @enderror"
                                    id="skill_category" name="skill_category" value="{{ old('skill_category') }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="skills_type" class="form-label">Skills Type <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('skills_type') is-invalid @enderror"
                                    id="skills_type" name="skills_type" value="{{ old('skills_type') }}" required>
                                @error('skills_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="has_certification" class="form-label">Has Certification</label>
                        ...
                        <div class="mb-3">
                            <label for="specific_skills" class="form-label">Specific Skills <span class="text-danger">*</span></label>
                            <textarea class="form-control @error('specific_skills') is-invalid @enderror"
                                id="specific_skills" name="specific_skills" rows="3" required>{{ old('specific_skills') }}</textarea>
                        ...
                        <div class="mb-3">
                            <label for="group_skills_details" class="form-label">Group Skills Details</label>
                            <textarea class="form-control @error('group_skills_details') is-invalid @enderror"
                                id="group_skills_details" name="group_skills_details" rows="3">{{ old('group_skills_details') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('certification_details') is-invalid @enderror"
                                id="certification_details" name="certification_details" rows="2">{{ old('certification_details') }}</textarea>
                        ...
                        <div class="mb-3">
                            <label for="support_received" class="form-label">Support Received</label>
                            <textarea class="form-control @error('support_received') is-invalid @enderror"
                                id="support_received" name="support_received" rows="3">{{ old('support_received') }}</textarea>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Save Skills Information
                            </button>
                        </div>
                    </form>
                </div>
