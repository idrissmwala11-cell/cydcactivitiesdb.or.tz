<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Center Leadership Information Form') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow rounded-lg p-6 border-2 border-blue-300">
                <div class="text-center mb-6">
                    <h2 class="text-xl font-bold text-gray-800 uppercase">CENTER LEADERSHIP INFORMATION FORM</h2>
                </div>
                ...
                <form method="POST" action="{{ route('center-leadership.store') }}" class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="center_name" class="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" value="{{ old('center_name') }}" placeholder="Enter center name" required>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="min-w-full border border-gray-300">
                                ...
                                <tbody id="leadership-table-body">
                                    <tr class="leadership-row">
                                        ...
                                        <td class="px-4 py-2 border border-gray-300">
                                            <input type="text" name="leadership_list[0][jina_la_kiongozi]" class="w-full border-gray-300 rounded-md focus:border-blue-500 focus:ring-blue-500" placeholder="Leader name" required>
                                        </td>
                                        <td class="px-4 py-2 border border-gray-300">
                                            <input type="text" name="leadership_list[0][namba_ya_kiongozi]" class="w-full border-gray-300 rounded-md focus:border-blue-500 focus:ring-blue-500" placeholder="Phone number" required>
                                        </td>
                                        <td class="px-4 py-2 border border-gray-300">
                                            <input type="text" name="leadership_list[0][cheo]" class="w-full border-gray-300 rounded-md focus:border-blue-500 focus:ring-blue-500" placeholder="Position" required>
                                        </td>
                                        <td class="px-4 py-2 border border-gray-300 text-center">
                                            <button type="button" class="remove-row bg-red-500 text-white px-2 py-1 rounded text-sm hover:bg-red-600" style="display: none;">Remove</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div>
                            ...
                            <textarea name="challenges" class="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" rows="4" placeholder="Describe any challenges the leaders are facing">{{ old('challenges') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <textarea name="feedback" class="mt-1 block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" rows="4" placeholder="Add any comments about the center leadership">{{ old('feedback') }}</textarea>
                        </div>
                    </div>
