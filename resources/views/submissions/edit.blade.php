    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            @php
                ...
                $backRoute = $isAdminView ? route('admin.submissions.show', $submission) : route('submissions.show', $submission);
                $updateRoute = $isAdminView ? route('admin.submissions.update', $submission) : route('submissions.update', $submission);
            @endphp
