...
<div class="py-10">
    <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
        ...
        <form action="{{ route('submissions.masomo-ya-mtaala.store') }}" method="POST" class="space-y-6">
            @csrf
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach (['3-5 years', '6-8 years', '9-11 years', '12-14 years', '15-17 years', '18+ years'] as $ageGroup)
                                    <option value="{{ $ageGroup }}" {{ old('darasa_la_mjaka_mingapi') === $ageGroup ? 'selected' : '' }}>
                                        {{ $ageGroup }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="rounded-3xl border border-emerald-100 bg-emerald-50/60 p-5">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            @foreach ([
                                ...
                                <label for="category_{{ $value }}" class="flex cursor-pointer items-center gap-3 rounded-2xl border border-white bg-white px-4 py-3 text-sm font-semibold text-gray-700 shadow-sm transition hover:border-emerald-200 hover:bg-emerald-50">
                                    <input
                                        type="radio"
                                        name="category"
                                        value="{{ $value }}"
                ...
                <div class="p-6 md:p-8">
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        <div>
                            ...
                            >{{ old('maoni_ya_mwanafunzi') }}</textarea>
                        </div>
                ...
                <div class="p-6 md:flex md:items-end md:justify-between md:gap-6">
                    <div class="md:w-72">
                        ...
                        >
                            ...
                            <option value="submit" {{ old('action') === 'submit' ? 'selected' : '' }}>Submit Record</option>
                        </select>
                    </div>
