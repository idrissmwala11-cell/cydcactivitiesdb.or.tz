            ...
            <div class="p-6">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white border border-gray-300">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">Number of Leaders</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">Term End</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">Submission Date</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">Submitted By</th>
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <h4 class="text-gray-500 mt-4 text-xl">No out-of-ministry leadership records found</h4>
                        <p class="text-gray-400 mt-2">Start by adding the first out-of-ministry leadership record.</p>
