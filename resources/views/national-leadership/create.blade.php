...
@section('title', 'National Leadership Information Form')
            ...
            <div class="p-6">
                ...
                <form action="{{ route('national-leadership.store') }}" method="POST">
                    ...
                    <div class="text-center mb-6">
                        <h2 class="text-xl font-bold text-gray-800">NATIONAL LEADERSHIP INFORMATION FORM</h2>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="center" class="block text-sm font-medium text-gray-700 mb-2">
                                    1. Center <span class="text-red-500">*</span>
                                </label>
                            ...
                            <table class="w-full border border-gray-300">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="border border-gray-300 px-4 py-2 text-left">Participant Number</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border border-gray-300 px-4 py-2">
                                            <input type="text" name="leaders[0][participant_number]" 
                                                   class="w-full px-2 py-1 border border-gray-300 rounded" 
                                                   placeholder="Participant number" required>
                                        </td>
                                        <td class="border border-gray-300 px-4 py-2">
                    ...
                    <!-- CHANGAMOTO -->
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold text-blue-600 mb-4 border-b border-blue-300 pb-2">CHALLENGES</h3>
                        ...
                        <div>
                            ...
                            <textarea id="challenges" name="challenges" rows="4" 
                                      placeholder="Enter any leadership challenges"
                    ...
                    <div class="mb-6">
                        ...
                        <div>
                            ...
                            <textarea id="comments" name="comments" rows="4" 
                                      placeholder="Enter any comments about national leadership"
