        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('home-visitation.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('jina') is-invalid @enderror" 
                                               id="jina" name="jina" value="{{ old('jina') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('namba') is-invalid @enderror" 
                                               id="namba" name="namba" value="{{ old('namba') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('shule') is-invalid @enderror" 
                                               id="shule" name="shule" value="{{ old('shule') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('darasa') is-invalid @enderror" 
                                               id="darasa" name="darasa" value="{{ old('darasa') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('last_program') is-invalid @enderror" 
                                               id="last_program" name="last_program" value="{{ old('last_program') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('likes_program') is-invalid @enderror" 
                                                id="likes_program" name="likes_program" required>
                                            <option value="">-- Select --</option>
                                            <option value="Yes" {{ old('likes_program') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                            <option value="No" {{ old('likes_program') == 'No' ? 'selected' : '' }}>No</option>
                                        </select>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('participant_comments') is-invalid @enderror" 
                                                  id="participant_comments" name="participant_comments" rows="3">{{ old('participant_comments') }}</textarea>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('mtaa') is-invalid @enderror" 
                                               id="mtaa" name="mtaa" value="{{ old('mtaa') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('mazingira') is-invalid @enderror" 
                                               id="mazingira" name="mazingira" value="{{ old('mazingira') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('nyumba') is-invalid @enderror" id="nyumba" name="nyumba" required>
                                            <option value="">-- Select --</option>
                                            <option value="Owned" {{ old('nyumba') == 'Owned' ? 'selected' : '' }}>Owned</option>
                                            <option value="Loan" {{ old('nyumba') == 'Loan' ? 'selected' : '' }}>Loan</option>
                                            <option value="Rented" {{ old('nyumba') == 'Rented' ? 'selected' : '' }}>Rented</option>
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('paa') is-invalid @enderror" id="paa" name="paa" required>
                                            <option value="">-- Select --</option>
                                            <option value="Iron Sheets" {{ old('paa') == 'Iron Sheets' ? 'selected' : '' }}>Iron Sheets</option>
                                            <option value="Grass" {{ old('paa') == 'Grass' ? 'selected' : '' }}>Grass</option>
                                            <option value="Other" {{ old('paa') == 'Other' ? 'selected' : '' }}>Other</option>
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('choo') is-invalid @enderror" id="choo" name="choo" required>
                                            <option value="">-- Select --</option>
                                            <option value="Has Toilet" {{ old('choo') == 'Has Toilet' ? 'selected' : '' }}>Has Toilet</option>
                                            <option value="No Toilet" {{ old('choo') == 'No Toilet' ? 'selected' : '' }}>No Toilet</option>
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('milo') is-invalid @enderror" id="milo" name="milo" required>
                                            <option value="">-- Select --</option>
                                            <option value="1" {{ old('milo') == '1' ? 'selected' : '' }}>1</option>
                                            <option value="2" {{ old('milo') == '2' ? 'selected' : '' }}>2</option>
                                            <option value="3" {{ old('milo') == '3' ? 'selected' : '' }}>3</option>
                                            <option value="More than 3" {{ old('milo') == 'More than 3' ? 'selected' : '' }}>More than 3</option>
                                        </select>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control @error('wanaume') is-invalid @enderror" 
                                               id="wanaume" name="wanaume" value="{{ old('wanaume',0) }}" min="0" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control @error('wanawake') is-invalid @enderror" 
                                               id="wanawake" name="wanawake" value="{{ old('wanawake',0) }}" min="0" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('tabia') is-invalid @enderror" 
                                                  id="tabia" name="tabia" rows="3">{{ old('tabia') }}</textarea>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('mtembelezaji') is-invalid @enderror" 
                                               id="mtembelezaji" name="mtembelezaji" value="{{ old('mtembelezaji') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('nafasi') is-invalid @enderror" 
                                               id="nafasi" name="nafasi" value="{{ old('nafasi') }}" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('maoni') is-invalid @enderror" 
                                                  id="maoni" name="maoni" rows="4">{{ old('maoni') }}</textarea>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('home-visitation.index') }}" class="btn btn-secondary me-md-2">
